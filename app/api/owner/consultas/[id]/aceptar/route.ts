...
// POST /api/owner/consultas/[id]/aceptar — pendiente_confirmacion -> aceptada
export async function POST(_request: Request, { params }: { params: { id: string } }) {
  ...
  if (!data) return NextResponse.json({ error: 'La consulta no está pendiente de confirmación' }, { status: 409 })
